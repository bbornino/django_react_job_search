  ...
  return (
    <div>
            ...
            {isAuthenticated() ? (
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu end>
                  ...
                  <DropdownItem tag={Link} to="/dropdown-edit/application-source">
                    <FontAwesomeIcon icon={faClipboardList} className="me-2" /> Posting URL Domain </DropdownItem>
                  <DropdownItem tag={Link} to="/dropdown-edit/employment-type">
                    <FontAwesomeIcon icon={faBriefcase} className="me-2" /> Employment Type </DropdownItem>
                  <DropdownItem tag={Link} to="/dropdown-edit/posting-status">
                    <FontAwesomeIcon icon={faSignal} className="me-2" /> Posting Status </DropdownItem>
                  <DropdownItem tag={Link} to="/dropdown-edit/location-type">
                    <FontAwesomeIcon icon={faLocationDot} className="me-2" /> Location Type </DropdownItem>
                  <DropdownItem tag={Link} to="/dropdown-edit/recruitment-stage">
                    <FontAwesomeIcon icon={faDiagramProject} className="me-2" /> Recruitment Stage </DropdownItem>
                  <DropdownItem divider />
                  <DropdownItem onClick={handleLogout}>
                    <FontAwesomeIcon icon={faRightFromBracket} className="me-2" />Logout</DropdownItem>
                </DropdownMenu>
              </UncontrolledDropdown>
            ) : (
              <>
      ...
      <Routes>
        ...
        <Route path="/dropdown-edit/:name" element={<ProtectedRoute element={<DropdownOptionsEdit />} />} />
