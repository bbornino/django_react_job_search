                ...
                <Row>
                    <Col>
                        <List type="unstyled" >
                            ...
                            <li className="check">If that doesn't work: use <a href="pathrise.com">Pathrise</a>.</li>
                            ...
                            <li className="check"> Employee Reviews.  Check out their standing on <a href="glassdoor.com">Glassdoor</a> 
                            ...
                            <li className="check"> Do they look at extra projects that you've worked on? Participate in open source projects.  
