...
from job_search.dropdown_options.dropdown_views import DropdownOptionsView
...
urlpatterns = [
    ...
    re_path(r"^api/dropdown_options/$", DropdownOptionsView.as_view()),
    re_path(r"^api/dropdown_options/([0-9]+)/$", DropdownOptionsView.as_view()),
    re_path(
